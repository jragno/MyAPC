    ...
    <div class="page-content-wrap">
        <div class="row">
            <div class="col-md-12">
                ...
                <form role="form" action="/announcements/create" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Create Announcement</strong></h3>
                        </div>
